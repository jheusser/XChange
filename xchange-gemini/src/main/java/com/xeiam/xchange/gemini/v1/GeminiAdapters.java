...
public final class GeminiAdapters {
  ...
  public static OrdersContainer adaptOrders(GeminiLevel[] bitfinexLevels, CurrencyPair currencyPair, OrderType orderType) {
    ...
    for (GeminiLevel bitfinexLevel : bitfinexLevels) {
  ...
  public static Ticker adaptTicker(GeminiTicker bitfinexTicker, CurrencyPair currencyPair) {
  ...
  public static AccountInfo adaptAccountInfo(GeminiBalancesResponse[] response) {
