...
public class GeminiCreditResponse {
  ...
  public GeminiCreditResponse(@JsonProperty("id") int id, @JsonProperty("currency") String currency, @JsonProperty("status") String status,
