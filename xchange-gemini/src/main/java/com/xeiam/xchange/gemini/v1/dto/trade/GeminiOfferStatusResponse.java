...
public class GeminiOfferStatusResponse {
  ...
  public GeminiOfferStatusResponse(@JsonProperty("id") int id, @JsonProperty("currency") String currency, @JsonProperty("rate") BigDecimal rate,
